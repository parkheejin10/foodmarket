...
<td><input type="text" name="mb_id" value="${sessionScope.mb_id}" class="form-control" readonly="readonly"><br></td>
</tr>
<tr>
...
<button type="button" onclick="javascript:check(),self.close(),window.opener.location.reload();" class="btn btn-theme">등록</button>
</div>
	...
	$(document).ready(function() {
				...
				$('.btn-theme').on("click", function(){
					...
					if ($('#qna_content').val()=="") {
						$('#qna_content').html("문의 내용을 입력해주세요.");
