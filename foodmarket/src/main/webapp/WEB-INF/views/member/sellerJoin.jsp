...
$("#mb_id").blur(function() {
	...
	var mb_id=$('#mb_id').val();
		...
		async : true,
		type : 'POST',
		data : {mb_id:$('#mb_id').val()}, //mb_id라는 이름으로 mb_id라는 데이터를 @WebServlet("/idsearch.do")에 보낸다
		url : 'idCheck',
...
// 비밀번호가 같은 경우 && 비밀번호 정규식
	...
	//회원 구분
	if(member.mb_seller[1].checked==false&&member.mb_seller[2].checked==false){
		inval_Arr[6] = false;
		alert('구분을 체크해주세요.');
		return false;
	} else{
...
<body>
	...
	<div class="wrapper">
		...
		<div class="breadcrumb-area pt-205 pb-210"
			style="background-image: url(../assets/img/bg/loginimg.jpg)">
			<div class="container">
				<div class="breadcrumb-content">
					...
					<ul>
						...
						<li><a href="../member/sellerJoin" style="color: white;">회원가입</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="login">
							<div class="login-form-container">
								<div class="login-form">
									...
									<input type="hidden" name="mb_seller" id="mb_seller" value="1">
									<!-- 버튼 -->
