(function($) {
    ...
    $('[id^="showlogin"]').on('click', function() {
    	var i = $(this).attr('id');
    	var check = i.replace('showlogin','checkoutlogin');
        $('#'+check).slideToggle(900);
    });
    ...
    $('askbar1').on('click', function() {
//    	"[id^='showlogin']"
//    	var i = $(this).attr('id');
    	alert("1");
//    	var check = i.replace('showlogin','checkout-login');
//    	alert(check);
//         $('#showask').slideToggle(900);
    });
